export type WeeklySchedule={day:string;time:string;format:string};
export type Venue={id:string;slug:string;name:string;address:string;city:string;state:string;zip:string;website?:string;mapUrl:string;description:string;image:string;active:boolean;weeklySchedule:WeeklySchedule[]};
